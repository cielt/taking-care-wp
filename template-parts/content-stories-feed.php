  ...
  <div class="w-max max-gl mx-auto px-5 pt-6 pb-6">
    <div class="section-header cf g">
      ...
      <div class="section-actions g-b g-b--1of1 g-b--m--4of12 px-0 m--t-alignR">
        <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'Stories' ) ) ); ?>" class="section-heading-cta">Read Stories <b class="fas fa-book dib" aria-hidden="true"></b></a>
        <span class="h-divider">|</span>
        <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'Share a Story' ))); ?>" class="section-heading-cta">Share a Story <b class="fas fa-comment dib" aria-hidden="true"></b></a>
      </div>
    </div>
