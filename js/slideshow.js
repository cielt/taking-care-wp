    ...
    imgPoll = setInterval(function () {
      ...
      if ($firstSlideImg.get(0).naturalWidth) {
        ...
        $slideshowFrame.slick({
          ...
          prevArrow: '<a href="#" class="slick-prev"><span class="vis-hidden">previous</span><b class="fas fa-chevron-left" aria-hidden="true"></b></a>',
          nextArrow: '<a href="#" class="slick-next"><span class="vis-hidden">next</span><b class="fas fa-chevron-right" aria-hidden="true"></b></a>',
          fade: true,
          lazyLoad: 'ondemand',
          dots: true,
