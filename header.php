...
<body <?php if (is_page_template('page-chapter-slideshow.php') || is_page_template('page-stories.php')) { body_class('nav-closed theme-dark header-waypoint'); } else if (is_single() || is_page_template('page-contact.php')) { body_class('nav-closed scroll-down'); } else { body_class('nav-closed header-waypoint'); }  ?> 
